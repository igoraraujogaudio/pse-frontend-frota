...
export async function POST() {
  try {
    const migrationSQL = `
-- ============================================================================
-- CORREÇÃO DEFINITIVA: CONTRATO É FILTRO OBRIGATÓRIO, NÃO REGRA DE PRIORIDADE
-- ============================================================================
-- O problema: contrato_id está sendo tratado como regra de prioridade
-- A solução: contrato_id deve ser filtro obrigatório em TODAS as regras
...
BEGIN
    ...
    -- ORDEM DE PRIORIDADE CORRETA (SEM CONTRATO COMO REGRA):
    ...
    -- Prioridade 3: Tipo de veículo + Contrato (filtro obrigatório)
    SELECT * INTO regra
    FROM public.regras_documentacao_veiculo
...
$$;
    ...
    console.log('🚀 Executando correção definitiva: contrato como filtro obrigatório...');
    ...
    if (error) {
      ...
      return NextResponse.json(
        { 
          success: false, 
          error: 'Erro ao executar correção da lógica de contrato',
